...
def get_parser():
    ...
    ##############################################################
    parser.add_argument(
        '--dataset', '-d', default='eth5', type=str,
        choices=['eth5'],
        help='Dataset selection: ETH-UCY, Stanford Drone, Intersection Drone, '
             'Forking Path')
    parser.add_argument(
        '--test_set', '-ts', default='eth', type=str,
        choices=['eth', 'hotel', 'univ', 'zara1', 'zara2'],
        help='Set this value to [eth, hotel, univ, zara1, zara2] for ETH-univ, ETH-hotel, UCY-univ, UCY-zara01, UCY-zara02')
    parser.add_argument(
    ...
    parser.add_argument(
        '--num_epochs', '-ne', default=30, type=int)
    parser.add_argument(
        '--batch_size', '-bs', default=128, type=int,
    ...
    parser.add_argument(
        '--validate_every', '-ve', default=15, type=int,
        help="Validate model every validate_every epochs")
    parser.add_argument(
        '--eval_every', '-ee', default=1, type=int,
        help="Validate model every validate_every batch")
    # 1 for slow but accurate results, 20 for fast results
    parser.add_argument(
    ...
    parser.add_argument('--prompt_type', default='arrow', type=str)
    parser.add_argument('--prompt_color', default='red', type=str)
    ...
    parser.add_argument(
        '--gamma', default=0.95, type=float, help='gamma for ExponentialLR scheduler')
    parser.add_argument(
    ...
    parser.add_argument('--arc_angle', default=None, type=int)
    parser.add_argument('--std', default=64, type=int)

    ##############################################################
    # General parameters
    ##############################################################
    parser.add_argument(
        '--down_factor', default=4, type=float,
